...
class Container extends React.Component {
  constructor(props) {
    ...
    this.state.formBuilderConfig = FormBuilder.valuesToConfig(
      formBuilderConfig,
      data
    );
  }
  ...
  render() {
    ...
    let { configeMode, random, formBuilderConfigerConfig } = this.state;
    var text;
    if (!configeMode) {
      text = 'Json配置模式';
    } else {
    ...
    return (
      <div className="demo-view">
        <Card
          ...
          extra={
            <Button size="small" onClick={this.changeToConfigMode}>
              {text}
            </Button>
          }
        >
          ...
          {!configeMode &&
            <div>
              ...
              <FormBuilderConfiger
                ...
                config={this.state.formBuilderConfigerConfig}
                selectSourceDataMap={selectSourceDataMap}
              />
            </div>}
        </Card>
        <Card title="FormBuilder" className="form-builder-content">
          <FormBuilder
